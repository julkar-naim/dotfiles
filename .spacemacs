...
(defun dotspacemacs/user-config ()
  ...
  (defun cpp-runner ()
    "Simeple C++ code runner"
    (interactive)
    (let ((file buffer-file-name)
          (script "~/.script/cpp_runner.sh"))
  ...
  (define-key evil-normal-state-map (kbd "<f8>") 'cpp-runner)
